...
I am trying to create a model using ridge regression for a player valuations dataset to predict the market value of a player. I have used the datset on https://www.kaggle.com/datasets/akarshsinghh/football-players-market-value-prediction?resource=download 

Using the code above as a reference for the experiment, can i get the code for this analysis over 100 trials?